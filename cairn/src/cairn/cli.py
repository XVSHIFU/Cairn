...
@click.option("--driver", default=None, show_default=False,
...
def research_worker(
    ...
    Claims queued research sessions, runs a tool-enabled Claude Code step in a
    per-session workspace under the host user configuration, reserves budget,
    honors pause, and records evidence/findings before generating a report.
    """
